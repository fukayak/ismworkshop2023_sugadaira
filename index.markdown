...
14:00-14:30 島谷健一郎（統数研）  
生物多様性の統計数理の曼陀羅  
  
14:30-14:40 田中健太（筑波大）  
開催地からのあいさつ＋事務連絡  
...
15:00-15:50 田中健太（筑波大）  
草原の継続期間による植物・昆虫群集の遷移：多様性と種特性の変化  
  
15:50-16:40 門脇浩明（京都大）  
理論・統計・シミュレーションの三位一体～あたらしい生態学教育をめざして～  
  
16:40-17:10 島谷健一郎（統数研）  
生物多様性指数の統計数理 サンプル被覆度とデータからの推定法  
  
（悪天候の場合、3件の話題提供をそれぞれ30分くらいずつ延長）  
...
- 松岡諒（東京大）
    - 自動撮影カメラデータに基づく時空間モデルの開発：時間点過程とRESTモデルの融合  
- 林息吹（京都大）
    - 多反復群集実験に現れる代替的な群集とその検出方法の探索  
- 冨髙まほろ（筑波大）
    - 歴史の古い草原ほど審美的価値は高いのか？―花形質に対する人々の選好性－  
- 大友優里（東北大）
    - Classification of biodiversity indicators based on context-dependence  
- 野口幹仁（京都大）
    - 森林地下部における根部共生微生物叢の形成要因  
- 平山楽（神戸大）
    - 草原継続の植物再生に伴う送粉ネットワーク構造・植物の繁殖成功の変化  
- 瀬尾夏未（神戸大）
    - ジェネラリスト送粉者は、個体レベルではスペシャリストであるのか？  
- 島（京都大）
    - 1年間のウナギ養殖水槽内の細菌群集動態  
- 井上哉太（東京農工大）
    - 温帯アリ群集における機能形質の垂直位置による違い  
- 冨塚暖史（東京都立大）
    - ベイツ型擬態におけるmimicの進化はmodelを絶滅から救済する  
　
